...
public interface UsersRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query("SELECT new com.example.HospitalManagement.System.model.user.UserInfo(u.id,u.fullName,u.username,u.email,u.contact,up.name,u.roles) FROM UserEntity u " +
